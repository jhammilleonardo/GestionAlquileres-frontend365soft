...
import { UpdateContractDTO, Contract, ContractStatus, SERVICE_OPTIONS, BANK_ACCOUNT_TYPES } from '../../../core/models/contract.model';
            ...
            @if (currentContract() && currentContract()!.status !== ContractStatus.BORRADOR) {
                <mat-card class="warning-card">
                    ...
                    <div class="warning-content">
                        ...
                        <p>
                            Solo se pueden editar contratos en estado <strong>Borrador</strong>.
                            Este contrato está en estado <strong>{{ ContractStatusLabels[currentContract()!.status] }}</strong>.
                        </p>
                    ...
                    <form [formGroup]="contractForm" (ngSubmit)="onSubmit()">
                        ...
                        <div class="form-section">
                            ...
                            <div class="info-readonly">
                                <div class="info-item">
                                    ...
                                    <span>{{ currentContract()!.tenant?.name || currentContract()!.tenant_name || 'N/A' }}</span>
                                </div>
                                <div class="info-item">
                                    <label>Propiedad:</label>
                                    <span>{{ currentContract()!.property?.title || currentContract()!.property_title || 'N/A' }}</span>
                                </div>
                            </div>
                        ...
                        <div class="form-section">
                            ...
                            <mat-form-field appearance="outline" class="full-width textarea-field">
                                ...
                                <mat-hint>Ej: Mantener la propiedad en buen estado, pagar servicios a su cargo</mat-hint>
                            </mat-form-field>
                            ...
                            <mat-form-field appearance="outline" class="full-width textarea-field">
                                ...
                                <mat-hint>Ej: Realizar reparaciones necesarias, mantener la propiedad habitable</mat-hint>
                            </mat-form-field>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <mat-form-field appearance="outline" class="full-width textarea-field">
                                ...
                                <mat-hint>Ej: Respetar horarios de descanso, no hacer ruido después de las 22hs</mat-hint>
                            </mat-form-field>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-row">
                                <mat-form-field appearance="outline" class="full-width">
                                    ...
                                    <mat-hint>Ej: El contrato se renueva automáticamente si ninguna de las partes avisa con 30 días de antelación</mat-hint>
                                </mat-form-field>
                            </div>
                            ...
                            <mat-form-field appearance="outline" class="full-width textarea-field">
                                ...
                                <mat-hint>Ej: Cualquiera de las partes puede rescindir con 60 días de preaviso</mat-hint>
                            </mat-form-field>
...
export class ContractEditComponent implements OnInit {
    ...
    private populateForm(contract: Contract): void {
        ...
        const monthlyRent = typeof contract.monthly_rent === 'string' ? parseFloat(contract.monthly_rent) : contract.monthly_rent;
        const lateFeePercentage = contract.late_fee_percentage && typeof contract.late_fee_percentage === 'string' ? parseFloat(contract.late_fee_percentage) : contract.late_fee_percentage;
        const autoIncreasePercentage = contract.auto_increase_percentage && typeof contract.auto_increase_percentage === 'string' ? parseFloat(contract.auto_increase_percentage) : contract.auto_increase_percentage;
    ...
    onSubmit(): void {
        ...
        const updateData: UpdateContractDTO = {
            ...
            auto_increase_percentage: formData.auto_increase_percentage ? parseFloat(formData.auto_increase_percentage) : undefined,
