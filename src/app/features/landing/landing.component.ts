...
import {
  LucideAngularModule, Building2, Users, FileText, DollarSign, Wrench,
  BarChart3, Shield, CheckCircle, ArrowRight, LogIn, Home, Star,
...
@Component({
            ...
            <div class="dashboard-3d">
              <div class="dashboard-card card-main">
                <div class="d-card-header">
                  <div class="d-dot red"></div><div class="d-dot yellow"></div><div class="d-dot green"></div>
                </div>
                <div class="d-card-body">
                  <div class="d-stat-row">
                    <div class="d-stat"><span class="d-num">24</span><span class="d-lbl">Propiedades</span></div>
                    <div class="d-stat"><span class="d-num">18</span><span class="d-lbl">Inquilinos</span></div>
                    <div class="d-stat"><span class="d-num">Bs 42k</span><span class="d-lbl">Ingresos</span></div>
                  </div>
        ...
        <div class="container">
          ...
          <div class="modules-grid">
            <div class="module-card reveal" style="--delay: 0ms">
              ...
              <h3>Propiedades</h3>
              <p>Gestiona tu portafolio completo de propiedades con información detallada, imágenes y documentos.</p>
              <ul class="module-features">
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Catálogo digital con imágenes</li>
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Control de disponibilidad</li>
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Historial de mantenimiento</li>
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Portal público de alquiler</li>
              </ul>
            ...
            <div class="module-card reveal" style="--delay: 80ms">
              ...
              <h3>Inquilinos</h3>
              <p>Administra toda la información de tus inquilinos y su comunicación desde un solo lugar.</p>
              <ul class="module-features">
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Base de datos centralizada</li>
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Portal de autogestión</li>
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Mensajería integrada</li>
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Documentos digitales</li>
              </ul>
              <div class="card-shine"></div>
            </div>
            ...
            <div class="module-card reveal" style="--delay: 160ms">
              ...
              <ul class="module-features">
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Generación automática PDF</li>
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Firma digital de inquilinos</li>
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Alertas de vencimiento</li>
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Renovación automática</li>
              </ul>
              <div class="card-shine"></div>
            </div>
            ...
            <div class="module-card reveal" style="--delay: 240ms">
              ...
              <ul class="module-features">
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Registro de pagos en línea</li>
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Aprobación de comprobantes</li>
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Recordatorios automáticos</li>
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Reportes financieros</li>
              </ul>
              <div class="card-shine"></div>
            </div>
            ...
            <div class="module-card reveal" style="--delay: 320ms">
              ...
              <ul class="module-features">
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Portal de solicitudes</li>
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Asignación de personal</li>
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Seguimiento en tiempo real</li>
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Historial de reparaciones</li>
              </ul>
              <div class="card-shine"></div>
            </div>
            ...
            <div class="module-card reveal" style="--delay: 400ms">
              ...
              <ul class="module-features">
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Dashboard interactivo</li>
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Ingresos y gastos</li>
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Tasa de ocupación</li>
                <li><lucide-icon [img]="CheckCircle" [size]="16"></lucide-icon> Exportación a Excel</li>
              </ul>
              <div class="card-shine"></div>
            </div>
          </div>
  ...
  styles: [`
    ...
    * { box-sizing: border-box; }
    ...
    .brand-name {
      font-size: 1.4rem; font-weight: 800; color: #0f172a; letter-spacing: -0.5px;
    }
    .top-actions { display: flex; gap: 12px; align-items: center; }
    .login-link  { display: flex; align-items: center; gap: 6px; }
    .signup-btn  { font-weight: 700 !important; border-radius: 8px !important; }
    ...
    .d-bar:nth-child(2) { animation-delay: 0.3s; }
    .d-bar:nth-child(3) { animation-delay: 0.6s; }
    .d-bar:nth-child(4) { animation-delay: 0.9s; }
    .d-bar:nth-child(5) { animation-delay: 1.2s; }
    .d-bar:nth-child(6) { animation-delay: 1.5s; }
    @keyframes barPulse {
      0%,100% { opacity: 1; }
      50%      { opacity: 0.7; }
    }
    ...
    .card-small span { font-size: 0.7rem; color: #94a3b8; }
    .card-small strong { font-size: 0.9rem; color: white; font-weight: 700; }
    .cs-icon { margin-bottom: 2px; }
    .cs-icon.green  { color: #10b981; }
    .cs-icon.orange { color: #f59e0b; }
    .cs-icon.blue   { color: #3b82f6; }

    .card-s1 { top: 60px; right: 0; animation-delay: 0s; }
    .card-s2 { top: 170px; right: 20px; animation-delay: 0.8s; }
    .card-s3 { bottom: 0; left: 60px; animation-delay: 1.6s; }
    ...
    .stat-item {
      ...
      gap: 6px; padding: 0 60px;
    }
    .stat-num {
      font-size: 2.5rem; font-weight: 800; color: #0f172a; letter-spacing: -1px;
    }
    .stat-desc {
      font-size: 0.875rem; color: #64748b; font-weight: 500;
    }
    .stat-divider {
      width: 1px; height: 60px; background: #e2e8f0; flex-shrink: 0;
    }
    ...
    .module-card:hover .card-shine { left: 150%; }
    ...
    .module-icon-wrap.properties { background: linear-gradient(135deg,#3b82f6,#2563eb); box-shadow: 0 8px 20px rgba(59,130,246,0.3); }
    .module-icon-wrap.tenants    { background: linear-gradient(135deg,#8b5cf6,#7c3aed); box-shadow: 0 8px 20px rgba(139,92,246,0.3); }
    .module-icon-wrap.leases     { background: linear-gradient(135deg,#06b6d4,#0891b2); box-shadow: 0 8px 20px rgba(6,182,212,0.3); }
    .module-icon-wrap.payments   { background: linear-gradient(135deg,#10b981,#059669); box-shadow: 0 8px 20px rgba(16,185,129,0.3); }
    .module-icon-wrap.maintenance{ background: linear-gradient(135deg,#f59e0b,#d97706); box-shadow: 0 8px 20px rgba(245,158,11,0.3); }
    .module-icon-wrap.reports    { background: linear-gradient(135deg,#ef4444,#dc2626); box-shadow: 0 8px 20px rgba(239,68,68,0.3); }

    .module-card h3 {
      font-size: 1.35rem; font-weight: 700; color: #0f172a; margin: 0 0 10px;
    }
    .module-card > p {
      font-size: 0.95rem; color: #64748b; line-height: 1.6; margin: 0 0 20px;
    }
    .module-features {
    ...
    .module-features li lucide-icon { color: #10b981; flex-shrink: 0; }
    ...
    .step-content h3 {
      font-size: 1.1rem; font-weight: 700; color: #0f172a; margin: 0 0 8px;
    }
    .step-content p {
    ...
    .cta-stars {
      display: flex; align-items: center; justify-content: center;
      gap: 4px; margin-bottom: 20px; color: #f59e0b;
    }
    .cta-stars span {
      color: #94a3b8; font-size: 0.875rem; margin-left: 8px;
    }
    .cta-box h2 {
      font-size: 2.75rem; font-weight: 800; color: white;
      margin: 0 0 16px; letter-spacing: -1px; line-height: 1.2;
    }
    .cta-box > p {
      font-size: 1.125rem; color: #94a3b8; margin: 0 0 40px; line-height: 1.6;
    }
    .cta-button-xl {
    ...
    .footer-brand p { font-size: 0.875rem; color: #64748b; line-height: 1.6; margin: 0; }
    .footer-links {
      display: grid; grid-template-columns: repeat(3,1fr); gap: 40px;
    }
    .footer-section h4 {
      font-size: 0.8rem; font-weight: 700; text-transform: uppercase;
      letter-spacing: 1px; margin: 0 0 16px; color: #cbd5e1;
    }
    .footer-section a {
    ...
    .footer-bottom p { font-size: 0.875rem; color: #475569; margin: 0; }
