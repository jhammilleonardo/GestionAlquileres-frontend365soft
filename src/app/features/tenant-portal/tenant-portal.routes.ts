...
export const TENANT_PORTAL_ROUTES: Routes = [
  {
    ...
    loadComponent: () =>
      import('./auth/tenant-login.component').then((m) => m.TenantLoginComponent),
  },
  {
    path: '',
    canActivate: [tenantAuthGuard],
    loadComponent: () =>
      import('./layout/tenant-layout.component').then((m) => m.TenantLayoutComponent),
    children: [
      // ==================== RUTAS PRE-CONTRATO ====================
      {
        path: 'home',
        ...
        loadComponent: () =>
          import('./home-pre-contract/home-pre-contract.component').then(
            (m) => m.HomePreContractComponent,
          ),
      },
      {
        ...
        canActivate: [tenantPreContractGuard],
        loadComponent: () =>
          import('./new-application/new-application.component').then(
        ...
        children: [
          {
            path: '',
            loadComponent: () =>
              import('./maintenance/tenant-maintenance-list.component').then(
                (m) => m.TenantMaintenanceListComponent,
              ),
          },
          {
            path: 'nueva',
            loadComponent: () =>
              import('./maintenance/tenant-create-request.component').then(
                (m) => m.TenantCreateRequestComponent,
              ),
          },
          {
            path: ':id',
            loadComponent: () =>
              import('./maintenance/tenant-request-detail.component').then(
                (m) => m.TenantRequestDetailComponent,
              ),
          },
        ],
      },
        ...
        children: [
          {
            path: '',
            loadComponent: () =>
              import('./payments/tenant-payments-list.component').then(
                (m) => m.TenantPaymentsListComponent,
              ),
          },
          {
            path: 'nuevo',
            loadComponent: () =>
              import('./payments/tenant-create-payment.component').then(
                (m) => m.TenantCreatePaymentComponent,
              ),
          },
          {
            path: 'qr',
            loadComponent: () =>
              import('./payments/tenant-qr-payments-list.component').then(
                (m) => m.TenantQrPaymentsListComponent,
              ),
          },
          {
            path: 'qr/nuevo',
            loadComponent: () =>
              import('./payments/tenant-qr-generate.component').then(
                (m) => m.TenantQrGenerateComponent,
              ),
          },
        ],
      },
        ...
        children: [
          {
            ...
            canActivate: [tenantWithContractGuard],
            loadComponent: () =>
              import('./documents/tenant-documents.component').then(
                (m) => m.TenantDocumentsComponent,
              ),
          },
