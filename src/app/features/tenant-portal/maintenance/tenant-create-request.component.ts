                ...
                <form [formGroup]="requestForm" (ngSubmit)="onSubmit()">
                    ...
                    <div class="form-section">
                        ...
                        <div class="type-options">
                            <label class="type-option" [class.selected]="requestForm.get('request_type')?.value === 'MAINTENANCE'">
                            ...
                            <label class="type-option" [class.selected]="requestForm.get('request_type')?.value === 'GENERAL'">
                        ...
                        <div class="form-section">
                            ...
                            <div class="category-grid">
                                @for (cat of categories; track cat.value) {
                                    <label class="category-option" [class.selected]="requestForm.get('category')?.value === cat.value">
                    ...
                    @if (requestForm.get('request_type')?.value === 'MAINTENANCE') {
                        <div class="form-section">
                            ...
                            <p class="section-desc">¿Autorizas que el personal entre a la propiedad sin tu presencia?</p>
                            ...
                            @if (requestForm.get('permission_to_enter')?.value === 'YES') {
                                <div class="entry-details">
                                    ...
                                    <mat-form-field appearance="outline" class="full-width">
                                        ...
                                        <textarea matInput formControlName="entry_notes" rows="2"
                                            placeholder="Ej: La llave esta debajo de la maceta..."></textarea>
                                    </mat-form-field>
                                </div>
                            }
                        </div>
