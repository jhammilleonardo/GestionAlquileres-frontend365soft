...
import { LucideAngularModule, ClipboardList, GitCompareArrows, Plus } from 'lucide-angular';
...
import { InspectionTemplatesDialogComponent } from './components/inspection-templates-dialog/inspection-templates-dialog.component';
...
@Component({
  ...
  imports: [
    ...
    InspectionTemplatesDialogComponent,
  ],
