...
import { LucideAngularModule, Building2, User, Mail, Lock, Eye, EyeOff, AlertCircle, CheckCircle2, ArrowRight, ArrowLeft } from 'lucide-angular';
                        ...
                        <form [formGroup]="adminForm" class="step-form">
                            ...
                            <mat-form-field appearance="outline" class="custom-field">
                                ...
                                <input
                                    ...
                                    autocomplete="name">
                                @if (adminForm.get('name')?.hasError('required') && adminForm.get('name')?.touched) {
                                    <mat-error>Requerido</mat-error>
                                }
                            ...
                            <mat-form-field appearance="outline" class="custom-field">
                                ...
                                <input
                                    ...
                                    autocomplete="email">
                                @if (adminForm.get('email')?.hasError('required') && adminForm.get('email')?.touched) {
                                    <mat-error>Requerido</mat-error>
                                }
                        ...
                        <form [formGroup]="passwordForm" (ngSubmit)="onSubmit()" class="step-form">
                            ...
                            <div class="terms-checkbox">
                                <mat-checkbox formControlName="acceptTerms" color="primary">
                                    Acepto los <a (click)="openTerms($event)" class="link">Términos y Condiciones</a> y la
...
export class RegisterComponent {
    ...
    onSubmit(): void {
        ...
        this.http.post(`${environment.apiUrl}auth/register-admin`, registerData).pipe(
            ...
            catchError(error => {
                this.isLoading.set(false);
                this.errorMessage.set(error.error?.message || 'Error al crear la cuenta. Por favor, intenta nuevamente.');
                throw error;
            })
        ).subscribe();
    }
        ...
        <div class="dialog-container">
            ...
            <mat-dialog-content>
                <div class="terms-content">
                    ...
                    <p>Al acceder y utilizar 365Soft (el "Servicio"), usted acepta estar sujeto a estos Términos y Condiciones de uso. Si no está de acuerdo con estos términos, no debe utilizar el Servicio.</p>

                    <h3>2. Descripción del Servicio</h3>
                    <p>365Soft es una plataforma de gestión de propiedades que permite a los administradores gestionar propiedades, inquilinos, contratos, pagos y mantenimiento de manera eficiente.</p>

                    <h3>3. Registro de Cuenta</h3>
                    <p>Para utilizar el Servicio, debe crear una cuenta proporcionando información precisa y completa. Usted es responsable de mantener la confidencialidad de su cuenta y contraseña.</p>
                    ...
                    <p>Todo el contenido, características y funcionalidad del Servicio son propiedad exclusiva de 365Soft y están protegidos por las leyes de propiedad intelectual.</p>

                    <h3>6. Privacidad y Seguridad de Datos</h3>
                    <p>Nos comprometemos a proteger su información personal de acuerdo con nuestra Política de Privacidad. Implementamos medidas de seguridad técnicas y organizativas para proteger sus datos.</p>

                    <h3>7. Limitación de Responsabilidad</h3>
                    <p>365Soft no será responsable por daños indirectos, incidentales, especiales o consecuentes que resulten del uso o la imposibilidad de usar el Servicio.</p>
                    ...
                    <h3>9. Terminación</h3>
                    <p>Podemos suspender o terminar su acceso al Servicio si viola estos términos o por cualquier otra razón a nuestra discreción.</p>
        ...
        <div class="dialog-container">
            ...
            <mat-dialog-content>
                <div class="privacy-content">
                    ...
                    <p>En 365Soft, nos tomamos muy en serio la privacidad de nuestros usuarios. Esta Política de Privacidad describe cómo recopilamos, usamos, compartimos y protegemos su información personal.</p>

                    <h3>2. Información que Recopilamos</h3>
                    <p>Recopilamos la siguiente información:</p>
                    <ul>
                        <li><strong>Información de cuenta:</strong> nombre, correo electrónico, teléfono, nombre de empresa</li>
                        <li><strong>Información de propiedades:</strong> direcciones, datos de propiedades y contratos</li>
                        <li><strong>Información de inquilinos:</strong> datos de contacto y documentación necesaria</li>
                        <li><strong>Información de pago:</strong> historial de transacciones y métodos de pago</li>
                    ...
                    <p>Conservamos su información personal mientras su cuenta esté activa o según sea necesario para cumplir con obligaciones legales.</p>
                    ...
                    <p>Utilizamos cookies y tecnologías similares para mejorar su experiencia, analizar el uso del Servicio y personalizar el contenido.</p>
                    ...
                    <p>Su información puede ser transferida y procesada en países distintos al suyo. Tomamos medidas para garantizar que su información reciba protección adecuada.</p>
