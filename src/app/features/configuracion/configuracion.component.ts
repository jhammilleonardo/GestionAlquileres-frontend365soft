        ...
        <div class="config-container">
            ...
            <div class="page-header">
                <div class="header-content">
                    ...
                    <div>
                        <h1>Configuración</h1>
                        <p>Personaliza tu experiencia en el panel de administración</p>
                    </div>
                </div>
            </div>
                ...
                <mat-card class="section-card">
                    ...
                    <div class="setting-row">
                        <div class="setting-info">
                            ...
                            <span class="setting-desc">Recibe alertas sobre pagos, mantenimiento y contratos</span>
                        </div>
                        <mat-slide-toggle
                    ...
                    <div class="setting-row" [class.disabled]="!settings.notifications_enabled">
                        <div class="setting-info">
                            ...
                            <span class="setting-desc">Con qué frecuencia se verifican nuevas notificaciones</span>
                        </div>
                ...
                <mat-card class="section-card">
                    ...
                    <div class="setting-row">
                        <div class="setting-info">
                            ...
                            <span class="setting-desc">Reduce el espacio entre elementos para ver más contenido</span>
                        </div>
                        <mat-slide-toggle
                ...
                <mat-card class="section-card">
                    ...
                    <div class="setting-row readonly">
                        <div class="setting-info">
                            ...
                            <span class="setting-desc">Detectada automáticamente desde tu navegador</span>
                        </div>
                    ...
                    <div class="setting-row readonly">
                        <div class="setting-info">
                            ...
                            <span class="setting-desc">Idioma de la interfaz</span>
                        </div>
