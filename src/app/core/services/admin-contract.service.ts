...
export class AdminContractService {
    ...
    loadDashboard(): void {
        ...
        this.apiHttp.get<ContractDashboard>(endpoint, {}, this.headers)
            .pipe(
                tap(dashboard => {
    ...
    loadContracts(filters?: ContractFilters): void {
        ...
        this.apiHttp.get<Contract[]>(endpoint, params, this.headers)
            .pipe(
                tap(contracts => {
    ...
    getContract(id: number): Observable<Contract> {
        ...
        return this.apiHttp.get<Contract>(endpoint, {}, this.headers)
            .pipe(
                tap(contract => {
    ...
    createContract(data: CreateContractDTO): Observable<Contract> {
        ...
        return this.apiHttp.post<Contract>(endpoint, data, this.headers)
            .pipe(
                tap(contract => {
                    const processedContract = this.processContract(contract);
    ...
    updateContract(id: number, data: UpdateContractDTO): Observable<Contract> {
        ...
        return this.apiHttp.patch<Contract>(endpoint, data, this.headers)
            .pipe(
                tap(contract => {
                    const processedContract = this.processContract(contract);
    ...
    updateStatus(id: number, statusData: UpdateContractStatusDTO): Observable<Contract> {
        ...
        return this.apiHttp.patch<Contract>(endpoint, statusData, this.headers)
            .pipe(
                tap(contract => {
                    const processedContract = this.processContract(contract);
    ...
    renewContract(id: number): Observable<RenewContractResponse> {
        ...
        return this.apiHttp.post<RenewContractResponse>(endpoint, {}, this.headers)
            .pipe(
                tap(response => {
    ...
    private processContract(contract: Contract): Contract {
        ...
        if (contract.auto_increase_percentage && typeof contract.auto_increase_percentage === 'string') {
