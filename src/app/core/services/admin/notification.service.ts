...
export class NotificationService {
  ...
  loadNotifications(options?: {
    ...
    this.http
      .get<Notification[]>(`${environment.apiUrl}${this.slug}/notifications`, { params })
      .pipe(
        tap((notifications) => {
  ...
  loadStats(): void {
    ...
    this.http
      .get<NotificationStats>(`${environment.apiUrl}${this.slug}/notifications/stats`, {})
      .pipe(
        tap((stats) => {
  ...
  getNotification(id: number): Observable<Notification> {
    return this.http
      .get<Notification>(`${environment.apiUrl}${this.slug}/notifications/${id}`, {})
      .pipe(
        tap((notification) => {
